<template>
    <div class="jewel-wrapper">
        <div v-for="(item, index) in useList" :key="index">
                ...
                <div class="jewel-cards">
                    <div class="jewel-content-wrapper">
                        ...
                        <div class="jewel-gem-wrapper">
                            <img :src="_cdnLink + useJewel[item.img]" />
                            <div class="jc-sticky">
                        ...
                        <div class="jewel-info-wrapper">
                            ...
                            <div class="js-btn" @click="apply"><p>已使用</p></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="jewel-border" v-if="index !== (useList.length -1)"></div>
        </div>
        <p class="tip" v-if="useList.length === 0">
            当前无已使用的宝石
        </p>
    </div>
</template>
    ...
    methods: {
        ...
        init () {
            getPromoCode({
                ...
                this.useList = res.data.usedList.filter((val, index, arr) => {
                    if (/\d+%/.test(val.title)) {
                        val.img = 1;
                ...
                this.useList = this.useList.reverse();
            });
        }
    },
    computed: {
