    ...
    <div class="activitytwo">
        ...
        <div class="at-info">
            ...
            <div class="at-info-body">
                <div><p>活动时间：</p><p>北京时间2018年8月1日0:00:01--2018年9月1日00:00:00</p></div>
                <div><p>活动对象：</p><p>全体新得利会员</p></div>
                <div><p>活动申明：</p><p>本活动小福星与笔笔存限PT、DT、ISB电子平台，流水挑战赛不限制平台</p></div>
                ...
                <div>
                    ...
                    <ol class="block-element">
                        <li>此活动可按照当日累计金额申请；</li>
                        <li>此活动小福星与笔笔存限PT、DT、ISB电子平台，流水挑战赛不限制平台；</li>
                        <li>此项优惠需要完成对应流水即可提款（最低提款金额100元）；</li>
                        <li>如果优惠未到账前已经进行投注，我们将视为您放弃本优惠；</li>
                        <li>此优惠笔笔存与网站洗码优惠共享，其余优惠均不与洗码优惠共享；</li>
...
export default {
    ...
    data () {
        return {
            electronicList: electronicActivity[1],
            recordId: null
        };
    },
    methods: {
