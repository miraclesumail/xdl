<template>
    <transition name="picker-fade">
        <div class="picker" v-show="state === 1" @touchmove.prevent @click="cancel" ref="pickerwrapper">
...
export default {
    ...
    mounted () {
        // console.log(1.7333 * 37.5);
        this.$refs.pickerwrapper.style.height = document.documentElement.clientHeight - (1.7333 * (document.documentElement.clientWidth / 10)) - (1.706 * (document.documentElement.clientWidth / 10)) + 'px';
        this.$nextTick(() => {
            console.log(this.data);
            this.pickerData = this.data.slice();
